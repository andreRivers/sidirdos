...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        $user = $this->db->get_where('as_user', ['email' => $email])->row_array();
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('flash_login', 'Email Tidak Aktif');
                redirect('auth');
            }
        } else {
            $this->session->set_flashdata('flash_login', 'Email Tidak Terdaftar');
            redirect('auth');
        }
    }
